...
<!-- 									<li class="formList_item">
						...
						<tr>
							...
							<td class="table_data">
								<div class="formList formList-inlineBlock">
									<div class="formList_item">
										<input type="checkbox" name="item2" value="1" id="item2" class="js-regularlyBtn" tabindex="1">
						...
						<tr>
							...
							<td class="table_data">
								<div class="formList formList-inlineBlock">
									<div class="formList_item">
										<input type="checkbox" name="item3" value="1" id="item3" class="js-regularlyBtn" tabindex="1">
						...
						<tr>
							...
							<td class="table_data">
								<div class="formList formList-inlineBlock">
									<div class="formList_item">
										<input type="checkbox" name="item4" value="1" id="item4" class="js-regularlyBtn" tabindex="1">
			...
			<div class="block_inner block_inner-7">
				<ul class="btn">
					...
					<li class="btn_box btn_box-sizeS btn_box-inline btn_box-color1">
						<a href="{$base_url}client/" class="focus" tabindex="1"><i class="btn_icon btn_icon-1"></i>登録</a>
					</li>
				</ul>
			</div>
		</div>
